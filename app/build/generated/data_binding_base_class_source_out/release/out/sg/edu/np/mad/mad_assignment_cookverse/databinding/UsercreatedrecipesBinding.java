...
public final class UsercreatedrecipesBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static UsercreatedrecipesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static UsercreatedrecipesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.usercreatedrecipes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static UsercreatedrecipesBinding bind(@NonNull View rootView) {
