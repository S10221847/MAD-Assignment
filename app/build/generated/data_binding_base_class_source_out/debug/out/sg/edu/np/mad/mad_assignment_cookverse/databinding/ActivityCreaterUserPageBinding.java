...
public final class ActivityCreaterUserPageBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityCreaterUserPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCreaterUserPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_creater_user_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCreaterUserPageBinding bind(@NonNull View rootView) {
