...
public class OnlineRecipesViewHolder extends RecyclerView.ViewHolder{
    TextView recname;
    TextView likes;
    public OnlineRecipesViewHolder(View itemView,OnlineRecyclerViewInterface onlineRecyclerViewInterface){
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() { //onclick listener for each cardview containing recipes
            ...
            public void onClick(View view) {
                if(onlineRecyclerViewInterface != null){
                    int pos = getAdapterPosition();

                    if(pos != RecyclerView.NO_POSITION){
                        onlineRecyclerViewInterface.onItemClick(pos);
                    }
                }
            }
        });
