...
public class MainActivity extends AppCompatActivity {
    ...
    public void createInitialDatabase() throws JSONException {
        Recipe recipeData = dbHandler.findRecipe(1); //it is only logical that the first recipe should be in the database

        if(recipeData == null){
            recipeData = new Recipe(); //1st Recipe, should automatically be assigned incremented primary key
